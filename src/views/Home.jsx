    ...
    return (
      ...
      <article>
        ...
        <div id="presentation">
            ...
            <p>
              PHASE 1: Free token distribution and yield farming.
            </p>
            <p>
              PHASE 2: Create or vote project ideas and add token value.
            </p>
            <p>
              PHASE 3: Manage NFTs with API Twitch and game launch.
            </p>
            </div>
            <div>
