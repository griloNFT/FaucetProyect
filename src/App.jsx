...
import PCMToken from './abis/PCMToken.json'
...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    if(!chainInUse){
      ...
      window.alert('INVALID NETWORK DETECTED! PLEASE CONNECT TO BSC-TESTNET NETWORK')
    } else {
      this.setState({ chainInUse })
      this.setState({ account: accounts[0] })
  
      try {
        const tuviellaToken = new web3.eth.Contract(PCMToken.abi, chainInUse.tuviellaTokenAddress)
        ...
        window.alert('PCM TOKEN contract not deployed to detected network.')
      }
      ...
      this.setState({ stakingPendingViellas: stakingPendingViellas, 
                      ...
                      tuviellaExpiry: tuviellaExpiry, 
                      tuviellaSecs: tuviellaSecs
                    })
      ...
      await provider.sendAsync({
        ...
        params: {
          ...
          options: {
            ...
            symbol: "PCM", // A ticker symbol or shorthand, up to 5 chars.
          ...
          <Router>
            <nav id="navigator" className="navbar navbar-dark fixed-top">
              ...
              <div id="menu">                                                         
                ...
                <NavLink className="inactive" activeClassName="active" to="/farm"><a>FARM</a></NavLink>                                     
